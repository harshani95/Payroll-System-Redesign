    ...
    <div className="w-full mx-auto mt-6 bg-white rounded-lg shadow-lg p-4 dark:bg-zinc-800">
      ...
      <form className="w-full space-y-4 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          />
             <InputField label="Branch Code" id="branch-code" type="text" disabled/>
            
          

          <InputField label="Account No" id="accountNo"  />
          <InputField label="Basic Salary" id="basic-salary" {...numberInputProps} type="number"/>
          <InputField label="Incentive" id="incentive" type="number" {...numberInputProps} />
          <InputField label="Bdget Allowence" id="budget-allowence" type="number" {...numberInputProps} />
           <InputField label="Special Incentive" id="special-incentive" type="number" {...numberInputProps} />
            <InputField label="Service Incentive" id="service-incentive" type="number" {...numberInputProps}/>
             <InputField label="Granding Incentive" id="granding-incentive" type="number"  {...numberInputProps}/>
          <InputField label="Adjustment" id="adjustment"  type="number" {...numberInputProps} />
          <InputField label="Transport Fee" id="transport-fee"  type="number" {...numberInputProps}/>
           <InputField label="Attendence Bonus" id="attendence-bonus" type="number" {...numberInputProps} />
